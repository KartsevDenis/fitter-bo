    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            ...
            <a class="logo" href="index.html">
                ...
                <b>
                    <!--This is dark logo icon--><img src="{{ asset('worker/plugins/images/pixeladmin-logo.png') }}"
                                                      alt="home" class="dark-logo"/>
                    <!--This is light logo icon--><img
                            src="{{ asset('worker/plugins/images/pixeladmin-logo-dark.png') }}" alt="home"
                            class="light-logo"/>
                </b>
                <!-- Logo text image you can use text also -->
                <span class="hidden-xs">
                        <!--This is dark logo text--><img src="{{ asset('worker/plugins/images/pixeladmin-text.png') }}"
                                                          alt="home" class="dark-logo"/>
                    <!--This is light logo text--><img src="{{ asset('worker/images/pixeladmin-text-dark.png') }}"
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu mailbox animated bounceInDown">
                    ...
                    <li>
                        <div class="drop-title">Сегодня празднуют день рождения</div>
                    </li>
                    ...
                    <li>
                        <div class="message-center">
                            ...
                            <a href="#">
                                ...
                                <div class="user-img">
                                    <img src="{{ asset('worker/plugins/images/users/pawandeep.jpg') }}" class="img-circle">
                        ...
                        <div class="message-center">
                            <a href="#">
                                <div class="user-img"><img
                                            src="{{ asset('worker/plugins/images/users/pawandeep.jpg') }}"
