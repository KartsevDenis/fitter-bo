...
@section('content')
    ...
    <form class="form-horizontal" data-toggle="validator" novalidate="true" method="post" action="{{ route('fit_insert_post')}}" enctype="multipart/form-data">
            ...
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="title" required class="form-control" value="" placeholder="Название публикации">
            ...
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="content" class="form-control my-editor">{!! '<p>сщтеуте</p>' !!}</textarea>
                        <script>
                            var editor_config = {
                                path_absolute : "/",
